...
class CheckoutTestEnviromentController extends ControllerBase{
    ...
    {             
        ...
        $this->assets
            ...
            ->addJs('https://stc.sandbox.pagseguro.uol.com.br/pagseguro/api/v2/checkout/pagseguro.directpayment.js',true);

        $this->view->setTemplateAfter('_bodychecktestenviroment');
    ...
    public function simulacaofreteAction() {
      $frete = Atacado::simulafrete($_POST);
    }
        ...
        if(isset($_SESSION['frete_simulacao'])){            
           //$frete = Produtos::fretecheckout(array('cep' => $_SESSION['frete_simulacao']));
            ...
            if((isset($cidades->cidades)) && (!empty($cidades->cidades))){
                Atacado::verificaRestricoes($_SESSION['frete_simulacao'],$cidades->cidades);
            }
            else{
                Atacado::verificaGratis($_SESSION['frete_simulacao']);
            }  
    ...
    public function pagamentoPixAction(){
        ...
        if((isset($_SESSION['id'])) && (!empty($_SESSION['id']))){
            ...
            $compra->tipopagamento    = 'Pagamento via Pix';           
    ...
    public function pagamentoCartaoAction(){
        ...
        $email_pagseguro = 'felipestscosta@outlook.com.br'; //voltar para $emailPagseguro
        $token_aplicacao_pagseguro = '43141F3220E441BC914B9CB90596EACB'; // voltar para $tokenPagseguro
