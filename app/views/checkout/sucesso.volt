                    ...
                    <div class="breadscrumb-contain breadscrumb-order">
                        <div class="order-box">
                            ...
                            <div class="order-contain">
                                <h3 class="theme-color">O Seu Pedido Foi Realizado Com Sucesso!</h3>
                                <br>
                                <!-- <h6>Transação ID: <?= $value->_id ?></h6> -->
                                 <h5 class="text-content">Se o seu <b>PAGAMENTO FEITO VIA PIX</b>, favor enviar o comprovante para o whatsapp <b><a href="https://api.whatsapp.com/send?phone=55{{ this.app.limpar_texto(empresa.whatsapp) }}"> {{empresa.whatsapp}}</a></b> <br>para que possamos processar com mais rapidez seu pedido. <br><br>
                                    <p>Se for <strong>CARTÃO DE CRÉDITO</strong> aguarde que confirmaremos seu pedido.</p>
                                    <a href="{{this.url.getBaseUri() ~ 'paginas/minhaconta'}}">ACESSAR <strong>ÁREA DO CLIENTE</strong></a> <br><br>
                                    <strong>NÃO FAZEMOS ENTREGAS NO DOMINGO.</strong>
                                 </h5>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Cart Section Start -->
    <section class="cart-section section-b-space" style="background-color: #f8f8f8;">
        <div class="container-fluid-lg">
