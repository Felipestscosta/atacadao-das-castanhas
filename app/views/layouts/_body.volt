...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P7QJ75Z"
                        ...
                        <div class="header-offer">
                            <div class="notification-slider">
                                ...
                                <div>
                                    <div class="timer-notification">
                                        <h6>Venda no atacado
                                            <a href="{{this.url.getBaseUri() ~ 'atacado'}}" class="text-white">Click aqui!</a>
                                        </h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="middle-box">
                                ...
                                <form class="search-box" method='GET' action="{{ this.url.getBaseUri() }}paginas/busca">
                                    <div class="input-group">
                                        <input type="search" name="busca" class="form-control" placeholder="Buscar por..."
                                    ...
                                    <li class="right-side">
                                        <div class="onhover-dropdown header-badge">
                                            ...
                                            <div class="onhover-div">
                                                <ul class="cart-list meusprodutos" style="max-height: 300px;overflow-y: auto;padding-right: 1.3rem;">
                                                    ...
                                                    <li class="product-box-contain">
                                                        <div class="drop-cart">
                                                            <a href="{{this.url.getBaseUri()}}produto/{{this.app.toURI(carrinho['name'])}}/{{carrinho['id_mongo']}}" class="drop-image">
                                                                <?php if(isset($carrinho['imagem'])):?>
                                                                <img src="{{link_imagens ~ carrinho['imagem']}}"
                                                                    class="blur-up lazyload" alt="dsa">
                                                                <?php else:?>
                                                ...
                                                <div class="price-box">
                                                    <h5>Total :</h5>
                                                    <h4 class="theme-color fw-bold total-carrinho-rapido">
                        ...
                        <div class="header-nav-left">
                            ...
                            <div class="category-dropdown">
                                ...
                                <ul class="category-list">
                                    {% for query in todascategorias %} 
                                    <?php $subcat = $this->app->getSub($query->_id);?>
                                    <li class="onhover-category-list">                                        
                                        <a href="{{this.url.getBaseUri()}}categoria/{{this.app.toURI(query.categoria_nome)}}/?cat={{query._id}}" class="category-name">
                                            <img src="{{link_imagens ~ query.imagem[1]}}" alt="">
                                            <h6>{{query.categoria_nome}}</h6>
                                            <?php if(isset($subcat) && (!empty($subcat))){?><i class="fa-solid fa-angle-right"></i><?php }?>
                                        </a>
                                        <?php $subcat = $this->app->getSub($query->_id);?>
                                        ...
                                        <div class="onhover-category-box">
                                            <div class="list-1">
                                                <div class="category-title-box">
                                                    <h5>{{query.categoria_nome}}</h5>
                                                </div>
                                                <ul>
                                                    <?php foreach($subcat as $key => $value){
                                                        $subnivel2 = $this->app->getSub2($value->_id);
                                                    ?>
                                                    <li>
                                                        <a href="{{this.url.getBaseUri()}}subcategoria/{{this.app.toURI(value.subcategoria_nome)}}/?cat={{query._id}}&sub={{value._id}}">
                                                            <?= $value->subcategoria_nome?>
                                                        </a>
                                                    </li>
                                                    <?php } ?>
                                                </ul>
                                    ...
                                    <div class="offcanvas-body">
                                        <ul class="navbar-nav">
                                            <!-- <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle" href="{{this.url.getBaseUri()}}" data-bs-toggle="dropdown">Home</a>
                                            </li> -->
   
                                            {% for query in categorias %}
                                            <?php $subcat = $this->app->getSub($query->_id);?>
                                            <li class="nav-item dropdown">
                                                <!-- {% if query.subcategoria_nome is not empty %}
                                                <a class="nav-link dropdown-toggle" href="{{this.url.getBaseUri()}}categoria/{{this.app.toURI(query.categoria_nome)}}/?cat={{query._id}}">{{ query.categoria_nome }}</a>
                                                {% else %} -->
                                                <a class="nav-link dropdown-toggle" data-bs-toggle="{{ query.subcategoria_nome == true ? "dropdown" : ''}}" href="{{this.url.getBaseUri()}}categoria/{{this.app.toURI(query.categoria_nome)}}/?cat={{query._id}}">{{ query.categoria_nome }} &nbsp;
                                                    <?php if(isset($subcat) && (!empty($subcat))){?><i class="fa-solid fa-angle-down"></i><?php } ?>
                                                </a>
                                                <!-- {% endif %} -->
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    ?> 
                                                    <li>
                                                        <a href="{{this.url.getBaseUri()}}subcategoria/{{this.app.toURI(value.subcategoria_nome)}}/?cat={{query._id}}&sub={{value._id}}" class="dropdown-item"><?= $value->subcategoria_nome?></a>
                                                        <?php if((isset($subnivel2)) && (!empty($subnivel2))){?>
                                                        <ul class="sub-menu">
                                                            <?php foreach($subnivel2 as $k => $v){?>
                                                            <li>
                                                                <a href="{{this.url.getBaseUri()}}subcategoria2/{{this.app.toURI(v.subcategoria2_nome)}}/{{v._id}}"><?= $v->subcategoria2_nome?></a>
                                                            </li>
                                                            <?php } ?>                                                            
                                                        </ul>
                                                        <?php } ?>
        ...
        <ul class="bolinha">
            ...
            <li>
                <a href="{{this.url.getBaseUri() ~ 'carrinho'}}">                    
                    ...
                    <span style="position: absolute;padding: 0px 40px; top: 17px; z-index: 999;{{ carrinho_quantidade is not empty ? "display: flex" : "display: none" }}" class="wrapper-cart-count"> 
                        <h5 style="padding: 3px 6px;border-radius: 50%;background-color: #de6032;color: #fff;font-size: 12px;" class="cart-count">
                            {{carrinho_quantidade}}
                        </h5>
                    </span>
                    <span>Carrinho</span>
                                ...
                                <ul>
                                    <li>
                                        <div class="footer-number">
                                            ...
                                            <div class="contact-number">
                                                <h6 class="text-content">Atendimento Online</h6>
                                                <h5>{{empresa.whatsapp}}</h5>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="footer-number">
                                            <i data-feather="home"></i>
                                            <div class="contact-number"> 
                                                <h6 class="text-content">Localização</h6>
                                                <a href="https://goo.gl/maps/n9DdrCDvt5z9KsNH9"><img src="{{this.url.getBaseUri() ~ 'images/localizacao.jpg'}}" alt="" style="box-shadow: 0 8px 10px #777;"></a>
                                            </div>
                                        </div>
                                    </li>
    ...
    <!-- Modal -->
        ...
        <div class="cookie-bar-box" id="privacy-warning">
            ...
            <div class="button-group">
                ...
                <button class="btn ok-button" onClick="privacy_close()">OK</button>
            </div>
        </div>
        <!-- Cookie Bar Box End -->
        ...
        <div class="item-section">
            ...
            <h6>
                <i class="iconly-Bag-2 icli"></i>
                <span id="count-carrinho-rapido-lateral">{{carrinho_quantidade}} Itens</span>
            </h6>
            <ul class="items-image" id="imagens-carrinho-rapido-lateral">
                {% set tres_primeiros_produtos = conteudo_carrinho | slice(-3) %}
                {% for carrinho in tres_primeiros_produtos %}
                    <li>
                        <img src="{{this.url.getBaseUri()}}/icontrole/{{ carrinho['imagem'] }}" alt="">
                    </li>
                {% endfor %}
                <li class="cart-count">
                    {% if carrinho_quantidade > 3 %}
                        {{ "+" ~ carrinho_quantidade }}
                    {% else %}
                        {{ carrinho_quantidade }}
                    {% endif %}
            ...
            <button 
                onclick="location.href = '/carrinho';" 
                class="btn item-button btn-sm fw-bold total-carrinho-rapido">
                <?= "R$ ".number_format($total_carrinho,2,',','.') ?>
            </button>
        </div>
        <!-- Items section End -->
                    ...
                    <form class="row g-4" id="localizacao" name="localizacao">
                        <div class="col-xxl-12">                               
                            <div class="form-floating theme-form-floating">
                                <input type="text" class="form-control" name="nome" id="nome" value="{{dados_cliente.nome}}">
                                ...
                                <li class="list-1">
                                    <div class="deal-offer-contain">
                                        ...
                                        <a href="{{this.url.getBaseUri()}}produto/{{this.app.toURI(value.nome)}}/{{value._id}}" class="deal-contain">
                                            <h5>{{value.nome}}</h5>                                           
                                            <h6>R$ {{value.variacoes[0]['valor']}} 
                                                <!-- <del><?php if(isset($result['de'])){ echo $result['de']; }?></del> -->
                                            </h6>
                                        </a>
                                    </div>
                                </li>
