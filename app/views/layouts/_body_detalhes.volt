...
<head>
    ...
    <title>{{ produto.nome is not empty ? produto.nome : '' }}</title>
    <meta name="description" content="{{ produto.nome is not empty ? produto.nome : '' }}">
    ...
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        <meta property="og:title" content="{{ produto.nome is not empty ? produto.nome : '' }}" />
        <meta property="og:type" content="website" />
        <meta property="og:description" content="{{ produto.nome is not empty ? produto.nome : '' }}" />
        <meta property="og:url" content="<?="https://".$_SERVER['SERVER_NAME'].$_SERVER["REQUEST_URI"]?>" />
        <meta property="og:image" content="{{link_imagens ~ produto.imagens[0]}}" />
                            ...
                            <div class="notification-slider">
                                <div>
                                    <div class="timer-notification">
                                        <h6><strong class="me-1">Bem Vindo ao Atacadão das Castanhas!</strong> Ofestas semanais.<strong class="ms-1">Aguarde mais novidades...</strong>
                                        </h6>
                                    </div>
                                </div>
        ...
        <ul class="bolinha">
            ...
            <li>
                <a href="{{this.url.getBaseUri() ~ 'carrinho'}}">                    
                    ...
                    {% if carrinho_quantidade is not empty %}
                    <span style="position: absolute;padding: 0px 40px; top: 17px; z-index: 999;">  <h5 style="padding: 3px 6px;
                        border-radius: 50%;background-color: #de6032;color: #fff;font-size: 12px;">{{carrinho_quantidade}}</h5>
                    </span>
                    {% endif %}
                    <span>Carrinho</span>
                </a>
