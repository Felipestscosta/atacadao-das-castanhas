                    ...
                    <div class="breadscrumb-contain">
                        ...
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ info_cat.categoria_nome }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            ...
                                            <span>{{ info_cat.categoria_nome }}</span>
                                        </button>
                                    </h2>
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <?php if(isset($todascategorias)){?>
                                                <?php foreach($todascategorias as $chave => $valor){?>
                                                    <?php if($valor->categoria_nome == $catid->categoria_nome){?>
                                            <ul class="category-list custom-padding custom-height">
                                                <?php
                                                $teste = $this->app->getSub($valor->_id);																								
                                                ...
                                                <li>
                                                    <div class="form-check ps-0 m-0 category-list-box">
                                                        ...
                                                        <label class="form-check-label" for="fruit">
                                                            <a <?php if((isset($subid)) && ($value->_id == $subid)) {echo "style=color:#B2C337;font-weight:bold;";}?> href="{{this.url.getBaseUri()}}subcategoria/{{this.app.toURI(value.subcategoria_nome)}}/?cat={{ valor._id }}&sub={{value._id}}" class="name"><?= $value->subcategoria_nome;?></a>
                                                            <span class="number">(<?php echo count($this->app->getCountSub($value->_id))?>)</span>
                                                        </label>
                                                    </div>
                                                </li>
                                                <?php }?>                                                
                        ...
                        <div class="top-filter-menu">
                            <div class="category-dropdown">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" onchange="this.form.submit()">
                                        <li>
                                            <a class="dropdown-item" id="pop" href="{{produto_url}}">Menor valor</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" id="low" href="javascript:void(0)">Maior valor</a>
                                        </li>
                                        <li>
